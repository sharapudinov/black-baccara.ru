...
?>
<div class="allcheck bx_filter <?=$templateData["TEMPLATE_CLASS"]?> bx_horizontal">
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			foreach($arResult["ITEMS"] as $key=>$arItem)
			{
				...
				if(isset($arItem["PRICE"])):
					if (!$arItem["VALUES"]["MIN"]["VALUE"] || !$arItem["VALUES"]["MAX"]["VALUE"] || $arItem["VALUES"]["MIN"]["VALUE"] == $arItem["VALUES"]["MAX"]["VALUE"])
						continue;
					?>
					<div class="bx_filter_parameters_box  check active">
			...
			foreach($arResult["ITEMS"] as $key=>$arItem)
			{
				...
				if (
					...
					continue;
				?>
				<div class="bx_filter_parameters_box check <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>active<?endif?>">
					<div class="opt_group_title"><?=$arItem["NAME"]?></div>
					<div class="bx_filter_block">
						<div class="bx_filter_parameters_box_container">
						<?
			...
			<div class="bx_filter_button_box active">
				<div class="bx_filter_block">
					<div class="bx_filter_parameters_box_container">
						<input class="" type="submit" id="set_filter" name="set_filter" value="<?=GetMessage("CT_BCSF_SET_FILTER")?>" />
						<input class="" type="submit" id="del_filter" name="del_filter" value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>" />
